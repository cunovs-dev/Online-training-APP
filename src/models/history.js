 ...
 * @LastEditTime: 2021-12-15 16:09:39
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \ChinaMobile-app\src\models\history.js
 */
import { parse } from 'qs';
import { model } from 'models/common';
import { Toast } from 'components';
import modelExtend from 'dva-model-extend';
import { queryHistory } from 'services/querylist';
...
export default modelExtend(model, {
  ...
  effects: {
    * queryList ({ payload = {}, callback }, { call, put, select }) {
      ...
      const { success, data: res, msg = '获取数据失败，请稍后再试。' } = yield call(queryHistory, {
        ...payload,
        nowPage: start,
        pageSize,
      });
